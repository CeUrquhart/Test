      ...
      <div class="row align-items-center">
        <div class="col-lg-4 col-md-8 mr-auto text-left">
          <div class="pr-md-5">
            ...
            <p>
              We focus on helping you build the right product as quickly as
              possible. This is what we do to get there:
            </p>
            <ul class="list-unstyled mt-5">
              <li class="py-2">
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    <h6 class="mb-0">A bit of product strategy.</h6>
                  </div>
                </div>
              </li>
              <li class="py-2">
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    <h6 class="mb-0">Designs that your users love.</h6>
                  </div>
                </div>
              </li>
              <li class="py-2">
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    <h6 class="mb-0">
                      You manage all of this in our internal tool.
                    </h6>
                  </div>
                </div>
              </li>
            ...
            <div class="col-lg-4 col-md-4">
              <div class="info text-left bg-danger info-raised shadow">
                ...
                <p class="description">
                  ...
                  follow my dreams and inspire the world.
                </p>
              </div>
            </div>
            <div class="col-lg-4 col-md-4">
              <div class="info text-left bg-default shadow">
                ...
                <p class="description">
                  ...
                  able to get good at. We’re constantly growing.
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="col-lg-4 col-md-4">
              <div class="info text-left bg-primary shadow">
                ...
                <p class="description">
                  ...
                  people are controlled by the force!
                </p>
              </div>
            </div>
            <div class="col-lg-4 col-md-4">
